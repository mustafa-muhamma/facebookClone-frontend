const SignUp = ({ setSign }) => {
    ...
    return (
        <div className="signUp-form">
            <button className="closeBtn" onClick={() => setSign(false)}>X</button>
            <form action="" className="signUp">
                <input type="text" placeholder="First Name" className="firstName" />
                <input type="text" placeholder="Last Name" className="lastName" />
                <input type="text" placeholder="Mobile NUmber Or Email Adress" className="mob" />
                <input type="password" placeholder="New Password" className="password" />
